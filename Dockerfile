...
RUN python -c "import os; os.environ['COQUI_TOS_AGREED']='1'; from TTS.api import TTS; TTS(model_name='tts_models/multilingual/multi-dataset/xtts_v2', progress_bar=True); print('TTS model pre-downloaded successfully')"
